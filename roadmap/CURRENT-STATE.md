...
- **Log**: _(populated by `evidence-tracker.py` on first tool call)_
...
Bootstrap mode. `BOOTSTRAP.md` in the project root walks through greenfield vs
existing detection, vision lock creation, and phase 1 design plan setup. After
bootstrap completes, it deletes itself and this file is updated with Phase 1
context.
