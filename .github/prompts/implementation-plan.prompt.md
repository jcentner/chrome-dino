...
You are creating a detailed implementation plan for a chrome-dino development phase. Read the project context:
...
- `path/to/file` — Description of what to create/change
  - [ ] Step 1: specific task
  - [ ] Step 2: specific task

**Tests:**
- `tests/path/to/test_file` — What to test
  - [ ] Test case 1: description
  - [ ] Test case 2: description (edge case)
...
- Include test cases for both happy paths and edge cases.
